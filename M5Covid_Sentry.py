# 2020-AUG-01 M5 Covid-Sentry ver 1.3 by Telegiangi61 https://github.com/Telegiangi61/M5Covid-Sentry under GNU General Public License v3.0
...
title0 = M5Title(title="M5 COVID-Sentry", x=85 , fgcolor=0xff0000, bgcolor=0xffffff)
...
while True:
    ...
    image0 = M5Img(1, -21, "res/italy4.jpg", True)
    title0 = M5Title(
        title="M5 COVID-Sentry", x=85, fgcolor=0xFF0000, bgcolor=0xFFFFFF
    )
